...
const MultiStepLogin = () => {
    ...
    const handleVerifySuccess = useCallback(
        ...
        [email, getValues, router]
    );

    /*
     * ================================
     * STEP 5: UNVERIFIED EMAIL LINK
     * ================================
     */
    ...
    const handleSendVerification = useCallback(async () => {
        ...
        try {
            await sendVerificationLink(currentEmail, "VERIFY_EMAIL");
            setResendCooldown(60);

            setNotification({
                type: "success",
                message: `Verification link successfully sent to ${currentEmail}. Please check your inbox.`,
            });
        } catch (error) {
            console.error(error);
            setNotification({
    ...
    }, [email, getValues, resendCooldown, sendVerificationLink]);
    ...
    }, [step, errors, register, email, getValues]);
        ...
        <FormProvider {...methods}>
            <Flex align="center" justify="center" className="min-h-[100dvh] p-4">
                <Box className="w-full max-w-md">
                    ...
                    <AlertDialog.Root
                        open={isNotFoundAlertOpen}
                        onOpenChange={setIsNotFoundAlertOpen}
                    >
                        <AlertDialog.Content maxWidth="400px" className="relative p-6">
                            ...
                            >
                                ...
                                <AlertDialog.Description size="2" my="4" className="text-center">
                                    ...
                                    <strong>{getValues("email")}</strong>. Would you like to
