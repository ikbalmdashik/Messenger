...
// // Sub-component: Quick Action Bar
// const ActionButtons = React.memo(() => (
//   <Flex justify="between" align="center" className="pt-1">
//     <IconButton variant="soft" color="sky" radius="full" size="2" className="cursor-pointer">
//       <Phone className="w-4 h-4" />
//     </IconButton>
//     <IconButton variant="soft" color="sky" radius="full" size="2" className="cursor-pointer">
//       <Video className="w-4 h-4" />
//     </IconButton>
//     <IconButton variant="soft" color="gray" radius="full" size="2" className="cursor-pointer">
...
// // Sub-component: User Overview Section
// const UserOverview = React.memo(({ userId }: { userId: number | null }) => (
//   <Card variant="surface" className="p-4 rounded-2xl bg-slate-100/40 dark:bg-slate-900/40">
//     <Text size="2" weight="bold" className="text-slate-800 dark:text-slate-200 block mb-3">
//       User Overview
//     </Text>
...
//         <Text size="2" weight="medium" className="font-mono text-slate-700 dark:text-slate-300">
//           #{userId}
//         </Text>
//       </Flex>
...
//           <Text size="2" weight="medium" className="text-emerald-500">
//             Online
//           </Text>
//         </Flex>
//       </Flex>
...
// // Sub-component: Shared Media Section
// const SharedFilesSection = React.memo(() => (
//   <Card variant="surface" className="p-4 rounded-2xl bg-slate-100/40 dark:bg-slate-900/40">
//     <Flex align="center" justify="between" className="mb-2">
//       <Flex align="center" gap="2">
//         <FolderCheck className="w-4 h-4 text-sky-500" />
//         <Text size="2" weight="bold" className="text-slate-800 dark:text-slate-200">
//           Shared Files
//         </Text>
//       </Flex>
//       <Text size="1" color="sky" className="cursor-pointer hover:underline">
//         View All
//       </Text>
//     </Flex>
...
//       align="center"
//       justify="center"
//       className="py-6 text-center border border-dashed border-[var(--gray-a4)] rounded-xl bg-slate-200/20 dark:bg-slate-800/20"
//     >
...
// const Rightbar: React.FC<RightbarProps> = ({ receiverId }) => {
//   const user: User | null = useCurrentUser(Number(receiverId));

//   // Compute initials once when user changes
...
//     <Flex
//       direction="column"
//       className="h-full w-full bg-slate-50/50 dark:bg-slate-950/40 backdrop-blur-xl border-l border-[var(--gray-a4)]"
//     >
...
//           >
//             <Card variant="surface" className="p-4 rounded-2xl bg-slate-100/40 dark:bg-slate-900/40 backdrop-blur-md">
//               <Flex direction="column" align="center" justify="center" className="text-center py-2">
...
//                 <Flex align="center" gap="1.5" className="mb-0.5">
...
//                 <Text size="2" color="gray" className="truncate max-w-[220px] mb-2">
//                   {user.email}
//                 </Text>

//                 <Flex gap="2" align="center" className="mt-1">
//                   <Badge color={user.isEmailVerified ? "green" : "amber"} variant="soft" size="1">
//                     {user.isEmailVerified ? "Verified Account" : "Unverified"}
//                   </Badge>
//                   {user.role && (
//                     <Badge color="sky" variant="surface" size="1" className="capitalize">
//                       {user.role}
//                     </Badge>
//                   )}
//                 </Flex>
...
//           {/* Chat Options & Security Card */}
//           <Card variant="surface" className="p-3 rounded-2xl bg-slate-100/40 dark:bg-slate-900/40">
//             <Flex direction="column" gap="2">
//               <Flex
//                 align="center"
//                 gap="2.5"
//                 className="p-2 rounded-lg hover:bg-slate-200/50 dark:hover:bg-slate-800/50 cursor-pointer transition-colors"
//               >
...
//                 align="center"
//                 gap="2.5"
//                 className="p-2 rounded-lg hover:bg-rose-500/10 cursor-pointer transition-colors text-rose-500"
//               >
